...
test('authenticated users can create and open a project', function () {
    ...
    expect($project->user_id)->toBe($user->id)
        ...
        ->and($project->composition['layers'][0]['fontFamily'])->toContain('Inter')
        ->and($project->composition['layers'][0]['lineHeight'])->toBe(1.1)
        ->and($project->composition['layers'][0]['letterSpacing'])->toBe(0)
        ->and($project->composition['layers'][0]['textAlign'])->toBe('left')
